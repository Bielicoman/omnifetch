...
if not exist "%YTDLP%" (
    ...
    echo   Rode %WHITE%1_SETUP.bat%RST% antes de baixar videos.
    echo.
    pause
    endlocal
    exit /b 1
...
set "ARIA_ARGS="
if "!HAS_ARIA!"=="1" set "ARIA_ARGS=--downloader aria2c"
cls
...
:settings
cls
call :banner "CONFIG" "preferencias salvas"
...
echo   %WHITE%[4]%RST% Abrir pasta data/logs
...
if "!SOPT!"=="2" (
    echo.
    echo  1 Chrome   2 Edge   3 Firefox   4 Brave
    set "B="
    set /p "B=Navegador: "
