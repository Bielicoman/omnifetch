...
(() => {
  ...
  const SCRIPT = [
    ...
    { type: 'cmd', text: 'Instalar.bat', typeSpeed: 50 },
    { type: 'pause', delay: 600 },
    ...brandLines(),
    { type: 'output', text: '  OmniFetch SETUP — instalador local', cls: 'term-highlight term-bold' },
    sep(),
    { type: 'pause', delay: 400 },
    { type: 'output', text: '' },
    { type: 'output', text: '  O que sera instalado:', cls: 'term-cmd' },
    { type: 'output', text: '    yt-dlp    downloader universal', cls: 'term-success' },
    { type: 'output', text: '    FFmpeg    merge audio/video', cls: 'term-success' },
    { type: 'output', text: '    aria2     acelerador', cls: 'term-success' },
    { type: 'output', text: '' },
    { type: 'pause', delay: 600 },
    sep(),
    { type: 'output', text: '  [1/3] yt-dlp', cls: 'term-info' },
    ...
    { type: 'output', text: '  [2/3] FFmpeg', cls: 'term-info' },
    { type: 'output', text: '  baixando: omnifetch-ffmpeg.zip', cls: 'term-dim' },
    { type: 'pause', delay: 800 },
    { type: 'output', text: '  [ok] ffmpeg.exe', cls: 'term-success term-bold' },
    { type: 'pause', delay: 300 },
    { type: 'output', text: '  [3/3] aria2', cls: 'term-info' },
    { type: 'pause', delay: 500 },
    { type: 'output', text: '  [ok] aria2c.exe', cls: 'term-success term-bold' },
    { type: 'pause', delay: 400 },
    { type: 'output', text: '' },
    { type: 'output', text: '  Setup finalizado. Rode OmniFetch.bat', cls: 'term-success term-bold' },
    ...
    { type: 'step', num: 2 },
    { type: 'prompt', text: '> ', delay: 500 },
    { type: 'cmd', text: 'OmniFetch.bat', typeSpeed: 50 },
    { type: 'pause', delay: 600 },
    ...brandLines(),
    { type: 'output', text: '  OmniFetch LAUNCHER', cls: 'term-output' },
    sep(),
    { type: 'pause', delay: 400 },
    { type: 'output', text: '' },
    { type: 'output', text: '  COMO QUER USAR HOJE?', cls: 'term-cmd' },
    { type: 'output', text: '' },
    { type: 'output', text: '    [1]  Downloader       cole o link, ENTER', cls: 'term-info' },
    { type: 'output', text: '    [2]  Conversor        arraste e converta', cls: 'term-info' },
    { type: 'output', text: '    [3]  OmniTools        cortes, legendas', cls: 'term-info' },
    { type: 'output', text: '    [4]  Setup            atualizar motores', cls: 'term-warn' },
    { type: 'output', text: '    [Q]  Sair', cls: 'term-dim' },
    sep(),
    { type: 'output', text: '  motores: yt-dlp on  ffmpeg on  aria2 on', cls: 'term-success' },
    sep(),
    { type: 'output', text: '' },
    { type: 'pause', delay: 1200 },
    { type: 'prompt', text: '  > ', delay: 300 },
    { type: 'cmd', text: '1', typeSpeed: 250 },
    { type: 'pause', delay: 700 },
    ...
    { type: 'step', num: 3 },
    { type: 'output', text: '' },
    { type: 'output', text: '  OmniFetch DOWNLOADER', cls: 'term-output' },
    sep(),
    { type: 'output', text: '' },
    { type: 'output', text: '  Cole um link e pressione ENTER.', cls: 'term-dim' },
    { type: 'output', text: '  Destino: C:\\Users\\Alex\\Downloads', cls: 'term-dim' },
    { type: 'output', text: '' },
    { type: 'pause', delay: 600 },
    { type: 'prompt', text: '  > ', delay: 300 },
    ...
    { type: 'clear' },
    { type: 'output', text: '' },
    { type: 'output', text: '  Qualidade — YouTube', cls: 'term-output' },
    sep(),
    { type: 'output', text: '' },
    { type: 'output', text: '  [ENTER] Melhor qualidade', cls: 'term-highlight term-bold' },
    { type: 'output', text: '  [1] MP4 auto   [4] 1080p', cls: 'term-cmd' },
    { type: 'output', text: '  [2] 4K         [A] MP3 320', cls: 'term-cmd' },
    { type: 'output', text: '' },
