...
---
Ative a automação dizendo: *"Com base nas instruções do criador-de-skills, construa uma skill especialista em [Sua Tarefa, ex: 'revisar código e encontrar vulnerabilidades de segurança']."**
